    ...
    const confirmDelete = async () => {
        ...
        try {
            if (deleteTarget.type === 'collection') {
                await apiClient.delete(`/collections/${deleteTarget.id}`);
                toast.success("Collection deleted");
                fetchCollections();
            } else if (deleteTarget.type === 'recipe') {
                await apiClient.delete(`/saved-recipes/${deleteTarget.id}`);
    ...
    return (
        <>
                        ...
                        >
                            <button 
                                onClick={(e) => {
                                    e.preventDefault();
                                    e.stopPropagation();
                                    setDeleteTarget({ type: 'recipe', id: recipeId });
                                }}
            ...
            <ConfirmationModal
                ...
                title={`Delete ${deleteTarget?.type === 'collection' ? 'Collection' : 'Recipe'}`}
